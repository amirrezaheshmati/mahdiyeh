...
urlpatterns = [
    ...
    path("comment/<str:product_name>/" , views.comments , name="comments") , 
    path("add_comment/<str:product_name>/" , views.add_comment , name="add_comment"),
    path("like_post/<str:where>/<str:post_name>/" , views.like_post , name="like_post"),
    path("like_comment/<int:comment_id>/<str:product_name>/" , views.like_comment , name="like_comment"),
    path("search_result/" , views.search_product , name="search_result"),
    path("delete_picture/<str:product_url>/<int:picture_id>/" , views.delete_picture , name="delete_picture"),
]